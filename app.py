...
def index():
    ...
    return render_template('home-v4d.html') #middle header added, cards added, database integrated
    # return render_template('home-v5l.html') #calendar, calculator, notes fully added
